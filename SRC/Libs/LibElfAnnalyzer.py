...
class ELFHEADER:
      def __init__(self):
            ...
            self.version2 = ""
            self.entrypoint = ""
            self.start_of_program_headers = ""
            self.start_of_section_headers = ""
            self.flags = ""
            self.elfheader_size = ""
            self.programheader_size = ""
            self.programheader_nb = ""
            self.sectionheader_size = ""
            self.sectionheader_nb = ""
            self.sectionheader_table_index = ""
            self.sizeof_magic = 16*BYTE
            self.sizeof_classe = BYTE
            self.sizeof_data = BYTE
            self.sizeof_version = BYTE
            self.sizeof_osabi = BYTE
            self.sizeof_abiversion = BYTE
            self.sizeof_type = BYTE
            self.sizeof_machine = BYTE
            self.sizeof_version2 = ""
            self.sizeof_entrypoint = ""
            self.sizeof_start_of_program_headers = ""
            self.sizeof_start_of_section_headers = ""
            self.sizeof_flags = ""
            self.sizeof_elfheader_size = ""
            self.sizeof_programheader_size = ""
            self.sizeof_programheader_nb = ""
            self.sizeof_sectionheader_size = ""
            self.sizeof_sectionheader_nb = ""
            self.sizeof_sectionheader_table_index = ""
